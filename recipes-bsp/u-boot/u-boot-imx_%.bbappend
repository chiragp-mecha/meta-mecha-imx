...
SRC_URI += " file://0001-Set-imx8mm-mecha-comet-m-gen1.dtb-as-default.patch \
			 ...
			 file://0004-Add-Support-for-4GB-DRAM-mickledore.patch \
			 ...
			 file://0010-Add-configs-imx8mm-evk-defconfig.patch \
			"

# Use this condition if switch to 2-GB-SOM or 4-GB-SOM
